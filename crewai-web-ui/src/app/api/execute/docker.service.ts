...
export async function executePythonScript(): Promise<ExecutePythonScriptSetupResult> { // Changed return type
  ...
  try {
    // The script writing part is removed, as files are now generated by the 'generate' endpoint.
  ...
  echo "--- Running crew via 'crewai run' ---" &&
  cd /workspace/agent_code && crewai run &&
