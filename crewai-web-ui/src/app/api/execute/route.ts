...
export async function POST(request: Request) {
  try {
    // The request body is no longer needed as the script is already in the workspace.
    // const body = await request.json();
    // const scriptContent = body.script;

    console.log("Received request to execute script. Setting up Docker container and stream...");
