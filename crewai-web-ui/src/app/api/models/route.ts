...
export async function GET() {
  ...
  const baseModels: Model[] = [
    ...
    { id: "chatgpt", name: "ChatGPT (Placeholder)" }, // Assuming this is a generic placeholder
    { id: "deepseek", name: "DeepSeek (Placeholder)" }  // Assuming this is a generic placeholder
  ];
  ...
  const geminiModelIds = [
    ...
    "gemini-1.0-pro",         // Alias or specific version for gemini-pro
